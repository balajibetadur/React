...
const greeting = {
	...
	subTitle:
		"I am Balaji Betadur, IBM Certified Data Science Entuhsiast. I am an undergraduate computer science major student from KLS Gogte Institute of Technology.

    Results-oriented individual with a background in performing scientific research, and to work as a researcher on challenging problems in Data Science and Machine learning. The work should be exciting and motivate me to come up with new ideas that will influence the way technology is used, and make a positive impact on people’s life.",
	resumeLink:
